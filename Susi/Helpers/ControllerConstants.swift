...
class ControllerConstants {
    ...
    static let skillListing = "AITCA Skills"
    static let chooseRoom = "Choose Room"
    static let trainHotword = "Let's train AITCA"
    ...
    static let meetSusi = "Meet AITCA, Your Artificial Intelligence for Personal Assistants, Robots, Help Desks and Chatbots."
    ...
    struct Settings {
        ...
        static let hotwordDirectionSubtitle = "Enable hotword detection to interact with AITCA in handsfree mode"
        ...
        static let rateSusi = "Rate AITCA"
        static let rateSusiSubtitle = "Rate SUSI on the App Store"
        static let shareSusi = "Share AITCA"
        static let shareSusiSubtitle = "Share the AITCA App with your friends"
        ...
        static let susiVoiceModel = "AITCA Voice Model"
    ...
    struct Login {
        ...
        static let login = "Login"
        static let forgotPassword = "Forgot Password?"
        static let signUpForSusi = "Sign Up for AITCA"
    ...
    struct Onboarding {
        ...
        static let chatSettings = "Chat Settings"
        static let loginDescription = "Login into the app using AITCA account or else signup to create a new account or just skip login"
        static let chatInterfaceDescription = "Interact with AITCA asking queries. Use microphone button for voice interaction"
        static let skillListingDescription = "Browse and try your favorite AITCA Skill"
    ...
    struct DeviceActivity {
        static let susiSSID = "AITCA"
        static let deviceCellIndentifier = "DeviceCell"
        static let connectedDetailText = "Click here to procceed with setup"
        static let doneSetupDetailText = "The Smart Speaker is successfully connected to your Wi-Fi and was added to your AITCA user account"
        ...
        static let passwordAlertMessage = "This is the final step, please enter your AITCA account's password to successfully connect to the speaker"
    ...
    struct AboutUs {
        static let susiDescription = "AITCA is an intelligent libre software personal assistant. It is capable of chat and voice interaction by using APIs to perform actions such as music playback , making to-do lists , setting alarms , streaming podcasts, playing audiobooks , and providing weather , traffic and other real time information. Additional functionalities can be added as console services using external APIs. AITCA is able to answer questions and depending upon the context will ask for additional information in order to perform the desired outcome. The core of the assistant is the AITCA server that holds the intelligence and personality of AITCA."
